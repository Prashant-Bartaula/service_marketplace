...
export default function WorkerSignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if(formData.age<18 || formData.age>60){
      return setErrorMessage("Age must be between 18 and 60");
    }
    ...
    try {
      setLoading(true);
      const res = await fetch("http://localhost:5000/api/auth/worker-sign-up", {
        method: "POST",
    ...
    >
      ...
      <div className="relative z-100 p-6 text-nowrap flex-grow max-w-[600px]">
        ...
        <form className="flex flex-col gap-6" onSubmit={(e) => handleSubmit(e)}>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="workingHour" className="font-medium tracking-wider">Working Hours</label>
              <select name="workingHour" id="workingHour" onChange={(e) => handleChange(e)} className="outline-none border-[1px] border-gray-500 px-3 py-2 rounded-lg cursor-pointer">
          ...
          <div className="flex flex-col gap-2">
            <label className="font-medium tracking-wider">Gender</label>
              <select name="gender" id="gender" onChange={(e) => handleChange(e)} className="outline-none border-[1px] border-gray-500 px-3 py-2 rounded-lg cursor-pointer">
                <option value="">Not selected</option>
          ...
          <div className="flex flex-col gap-2 w-[200px]">
            <label htmlFor="age" className="font-medium tracking-wider">
              Age
            </label>
            <input
              type="number"
        ...
        <div className="flex flex-col gap-3 mt-14">
          ...
          {errorMessage && (
            <h1 className="bg-red-300 p-2 text-red-900 text-center rounded-lg mt-3 text-lg text-wrap">
              {errorMessage}
            </h1>
          )}
        </div>
